...
void FilamentRenderer::setup_default_lighting() {
    ...
    filament::LightManager::Builder(filament::LightManager::Type::DIRECTIONAL)
        .color(filament::Color::toLinear<filament::ACCURATE>(filament::sRGBColor(0.98f, 0.95f, 0.88f)))
    ...
    static const filament::math::float3 sh_harmonics[9] = {
        filament::math::float3(0.75f, 0.75f, 0.80f),
        filament::math::float3(0.10f, 0.10f, 0.15f),
        filament::math::float3(-0.15f, -0.15f, -0.10f),
        filament::math::float3(0.05f, 0.05f, 0.05f),
