...
std::string NativeDialogs::open_file(const std::string& title, const std::string& default_path,
                                     const std::vector<std::string>& filters) {
  if (!pfd::settings::available()) {
    std::cerr << "[NativeDialogs] No desktop dialog backend (zenity/kdialog) available."
              << std::endl;
    return "";
  }
...
std::string NativeDialogs::save_file(const std::string& title, const std::string& default_path,
                                     const std::vector<std::string>& filters) {
  if (!pfd::settings::available()) {
    std::cerr << "[NativeDialogs] No desktop dialog backend (zenity/kdialog) available."
              << std::endl;
...
std::string NativeDialogs::select_folder(const std::string& title,
