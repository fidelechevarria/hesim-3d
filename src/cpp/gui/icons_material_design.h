...
// for C and C++
// from codepoints res/fonts/materialdesignicons.css
// for use with font res/fonts/materialdesignicons-webfont.ttf

#pragma once

#define FONT_ICON_FILE_NAME_MDI "res/fonts/materialdesignicons-webfont.ttf"
